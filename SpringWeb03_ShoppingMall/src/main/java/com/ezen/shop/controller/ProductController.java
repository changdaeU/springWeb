...
public class ProductController {
	...
	public ModelAndView category(
			/* Model model, */ @RequestParam("kind") String kind /*HttpServletRequest request*/) {
		...
		// 매개변수 위치에있는 @RequestParam("kind") String kind는
		// 변수선언과 동시에 전달되는 파라미터를 받아서 저장하는 역할을 합니다.
		// HttpServletRequest request와 String kind = request.getParameter("kind");는
		// 생략이 가능합니다.
	...
	public ModelAndView productDetail( @RequestParam("pseq") String pseq) {
